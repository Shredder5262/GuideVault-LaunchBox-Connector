...
public sealed class OpenStrategyGuideMenuItem : IGameMenuItemPlugin
{
    public string Caption => "GuideVault: Open Strategy Guide";
    ...
    public void OnSelected(IGame selectedGame) => Open(selectedGame, "Strategy Guide");
    public void OnSelected(IGame[] selectedGames)
    {
        var game = selectedGames?.FirstOrDefault();
        if (game is not null) Open(game, "Strategy Guide");
    }
